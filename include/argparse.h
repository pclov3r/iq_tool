...
enum argparse_option_flags {
    ...
    // CHANGE: Added for custom formatting of help text.
    OPT_LONG_NOPREFIX = 2, /* disable the '--' prefix for long options */
};
...
struct argparse_option {
    ...
    // BUGFIX: Removed 'const' from short_name to allow struct assignment.
    char short_name;
