/**
 * @file utilities.h
 * @brief Defines the interface for general-purpose utility and helper
 * functions.
 *
...
/**
 * @brief Formats a file size in bytes into a human-readable string (B, KB, MB,
 * GB).
 ...
 * @return A pointer to the beginning of the trimmed content within the original
 * string.
 */
 ...
 * Uses a strict threshold clamp to preserve signal purity while preventing
 * log10(0).
...
bool utility_verify_output_path(const struct AppConfig *config,
