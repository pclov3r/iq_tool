 ...
 *
 * This file acts as the configuration manifest for SDR input hardware. It
 * isolates physical constraints, such as sample rates, filter attenuations, and
 * buffer sizes, from the central DSP process_chain and the Module Registry.
 */
