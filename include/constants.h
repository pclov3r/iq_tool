...
#define BLADERF_TRANSFER_SIZE_SECONDS    0.20

// --- BladeRF Adaptive Streaming Profiles ---
#define BLADERF_PROFILE_LOWLATENCY_NUM_BUFFERS        16
#define BLADERF_PROFILE_LOWLATENCY_NUM_TRANSFERS      8

#define BLADERF_PROFILE_BALANCED_NUM_BUFFERS          32
#define BLADERF_PROFILE_BALANCED_NUM_TRANSFERS        16

#define BLADERF_PROFILE_HIGHTHROUGHPUT_NUM_BUFFERS    48
#define BLADERF_PROFILE_HIGHTHROUGHPUT_NUM_TRANSFERS  24
