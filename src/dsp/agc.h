 ...
 * automatic gain control (AGC) object. It utilizes a self-contained Harris/LMS
...
#include "core/app_context.h" // Provides AppConfig, AppContext, and ComplexFloat
#include <stdbool.h>

// --- Function Declarations ---

/**
 * @brief Creates and configures the AGC logic based on the application
 * configuration.
 *
 ...
 * Measures block RMS, computes error, applies deadband, and updates gain via
 * LMS.
 *
 * @param app Pointer to the application app.
