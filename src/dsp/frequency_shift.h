#ifndef DSP_FREQUENCY_SHIFT_H
#define DSP_FREQUENCY_SHIFT_H
 ...
 * @param shift_hz The frequency shift in Hz (positive for up-shift, negative
 * for down-shift).
 ...
 * Can be the same as input_buffer.
 ...
 *
 * This is used to handle stream discontinuities (e.g., hardware source
 * overruns) to prevent phase jumps in the output signal.
 *
