...
static const PresetKeyHandler key_handlers[] = {
    ...
    { "output_sample_rate",      PRESET_KEY_STRTOD, offsetof(PresetDefinition, rate_hz),         offsetof(PresetDefinition, rate_hz_provided) },
    { "baseband_sample_rate",    PRESET_KEY_STRTOD, offsetof(PresetDefinition, baseband_sample_rate_hz), offsetof(PresetDefinition, baseband_sample_rate_provided) },
    { "output_sample_format", PRESET_KEY_STRDUP, offsetof(PresetDefinition, output_sample_format),  0 },
    { "baseband_sample_format", PRESET_KEY_STRDUP, offsetof(PresetDefinition, baseband_sample_format),  0 },
    ...
    { "baseband-gain-multiplier", PRESET_KEY_STRTOF, offsetof(PresetDefinition, baseband_gain),       offsetof(PresetDefinition, baseband_gain_provided) },
    ...
    { "output-agc",              PRESET_KEY_BOOL,   offsetof(PresetDefinition, output_agc_enable),           offsetof(PresetDefinition, output_agc_enable_provided) },
    { "output-agc-target",       PRESET_KEY_STRTOF, offsetof(PresetDefinition, output_agc_target),        offsetof(PresetDefinition, output_agc_target_provided) },
    { "baseband-agc",              PRESET_KEY_BOOL,   offsetof(PresetDefinition, baseband_agc_enable),           offsetof(PresetDefinition, baseband_agc_enable_provided) },
    { "baseband-agc-target",       PRESET_KEY_STRTOF, offsetof(PresetDefinition, baseband_agc_target),        offsetof(PresetDefinition, baseband_agc_target_provided) },
