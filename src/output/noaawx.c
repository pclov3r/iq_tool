...
static const FipsCode fips_table[] = {
    ...
    {1000, "AL", "Entire State"},
    {2000, "AK", "Entire State"},
    {4000, "AZ", "Entire State"},
    {5000, "AR", "Entire State"},
    {6000, "CA", "Entire State"},
    {8000, "CO", "Entire State"},
    {9000, "CT", "Entire State"},
    {10000, "DE", "Entire State"},
    {11000, "DC", "Entire State"},
    {12000, "FL", "Entire State"},
    {13000, "GA", "Entire State"},
    {15000, "HI", "Entire State"},
    {16000, "ID", "Entire State"},
    {17000, "IL", "Entire State"},
    {18000, "IN", "Entire State"},
    {19000, "IA", "Entire State"},
    {20000, "KS", "Entire State"},
    {21000, "KY", "Entire State"},
    {22000, "LA", "Entire State"},
    {23000, "ME", "Entire State"},
    {24000, "MD", "Entire State"},
    {25000, "MA", "Entire State"},
    {26000, "MI", "Entire State"},
    {27000, "MN", "Entire State"},
    {28000, "MS", "Entire State"},
    {29000, "MO", "Entire State"},
    {30000, "MT", "Entire State"},
    {31000, "NE", "Entire State"},
    {32000, "NV", "Entire State"},
    {33000, "NH", "Entire State"},
    {34000, "NJ", "Entire State"},
    {35000, "NM", "Entire State"},
    {36000, "NY", "Entire State"},
    {37000, "NC", "Entire State"},
    {38000, "ND", "Entire State"},
    {39000, "OH", "Entire State"},
    {40000, "OK", "Entire State"},
    {41000, "OR", "Entire State"},
    {42000, "PA", "Entire State"},
    {44000, "RI", "Entire State"},
    {45000, "SC", "Entire State"},
    {46000, "SD", "Entire State"},
    {47000, "TN", "Entire State"},
    {48000, "TX", "Entire State"},
    {49000, "UT", "Entire State"},
    {50000, "VT", "Entire State"},
    {51000, "VA", "Entire State"},
    {53000, "WA", "Entire State"},
    {54000, "WV", "Entire State"},
    {55000, "WI", "Entire State"},
    {56000, "WY", "Entire State"},
    {60000, "AS", "Entire State"},
    {66000, "GU", "Entire State"},
    {69000, "MP", "Entire State"},
    {72000, "PR", "Entire State"},
    {74000, "UM", "Entire State"},
    {78000, "VI", "Entire State"},
    {1001, "AL", "Autauga County"},
    {1003, "AL", "Baldwin County"},
    {1005, "AL", "Barbour County"},
    {1007, "AL", "Bibb County"},
    {1009, "AL", "Blount County"},
    {1011, "AL", "Bullock County"},
    {1013, "AL", "Butler County"},
    {1015, "AL", "Calhoun County"},
    {1017, "AL", "Chambers County"},
    {1019, "AL", "Cherokee County"},
    {1021, "AL", "Chilton County"},
    {1023, "AL", "Choctaw County"},
    {1025, "AL", "Clarke County"},
    {1027, "AL", "Clay County"},
    {1029, "AL", "Cleburne County"},
    {1031, "AL", "Coffee County"},
    {1033, "AL", "Colbert County"},
    {1035, "AL", "Conecuh County"},
    {1037, "AL", "Coosa County"},
    {1039, "AL", "Covington County"},
    {1041, "AL", "Crenshaw County"},
    {1043, "AL", "Cullman County"},
    {1045, "AL", "Dale County"},
    {1047, "AL", "Dallas County"},
    {1049, "AL", "DeKalb County"},
    {1051, "AL", "Elmore County"},
    {1053, "AL", "Escambia County"},
    {1055, "AL", "Etowah County"},
    {1057, "AL", "Fayette County"},
    {1059, "AL", "Franklin County"},
    {1061, "AL", "Geneva County"},
    {1063, "AL", "Greene County"},
    {1065, "AL", "Hale County"},
    {1067, "AL", "Henry County"},
    {1069, "AL", "Houston County"},
    {1071, "AL", "Jackson County"},
    {1073, "AL", "Jefferson County"},
    {1075, "AL", "Lamar County"},
    {1077, "AL", "Lauderdale County"},
    {1079, "AL", "Lawrence County"},
    {1081, "AL", "Lee County"},
    {1083, "AL", "Limestone County"},
    {1085, "AL", "Lowndes County"},
    {1087, "AL", "Macon County"},
    {1089, "AL", "Madison County"},
    {1091, "AL", "Marengo County"},
    {1093, "AL", "Marion County"},
    {1095, "AL", "Marshall County"},
    {1097, "AL", "Mobile County"},
    {1099, "AL", "Monroe County"},
    {1101, "AL", "Montgomery County"},
    {1103, "AL", "Morgan County"},
    {1105, "AL", "Perry County"},
    {1107, "AL", "Pickens County"},
    {1109, "AL", "Pike County"},
    {1111, "AL", "Randolph County"},
    {1113, "AL", "Russell County"},
    {1115, "AL", "St. Clair County"},
    {1117, "AL", "Shelby County"},
    {1119, "AL", "Sumter County"},
    {1121, "AL", "Talladega County"},
    {1123, "AL", "Tallapoosa County"},
    {1125, "AL", "Tuscaloosa County"},
    {1127, "AL", "Walker County"},
    {1129, "AL", "Washington County"},
    {1131, "AL", "Wilcox County"},
    {1133, "AL", "Winston County"},
    {2013, "AK", "Aleutians East Borough"},
    {2016, "AK", "Aleutians West Census Area"},
    {2020, "AK", "Anchorage Municipality"},
    {2050, "AK", "Bethel Census Area"},
    {2060, "AK", "Bristol Bay Borough"},
    {2063, "AK", "Chugach Census Area"},
    {2066, "AK", "Copper River Census Area"},
    ...
    {2110, "AK", "Juneau City and Borough"},
    ...
    {2195, "AK", "Petersburg Borough"},
    {2198, "AK", "Prince of Wales-Hyder Census Area"},
    {2220, "AK", "Sitka City and Borough"},
    {2230, "AK", "Skagway Municipality"},
    {2240, "AK", "Southeast Fairbanks Census Area"},
    {2275, "AK", "Wrangell City and Borough"},
    {2282, "AK", "Yakutat City and Borough"},
    {2290, "AK", "Yukon-Koyukuk Census Area"},
    {4001, "AZ", "Apache County"},
    {4003, "AZ", "Cochise County"},
    {4005, "AZ", "Coconino County"},
    {4007, "AZ", "Gila County"},
    {4009, "AZ", "Graham County"},
    {4011, "AZ", "Greenlee County"},
    {4012, "AZ", "La Paz County"},
    {4013, "AZ", "Maricopa County"},
    {4015, "AZ", "Mohave County"},
    {4017, "AZ", "Navajo County"},
    {4019, "AZ", "Pima County"},
    {4021, "AZ", "Pinal County"},
    {4023, "AZ", "Santa Cruz County"},
    {4025, "AZ", "Yavapai County"},
    {4027, "AZ", "Yuma County"},
    {5001, "AR", "Arkansas County"},
    {5003, "AR", "Ashley County"},
    {5005, "AR", "Baxter County"},
    {5007, "AR", "Benton County"},
    {5009, "AR", "Boone County"},
    {5011, "AR", "Bradley County"},
    {5013, "AR", "Calhoun County"},
    {5015, "AR", "Carroll County"},
    {5017, "AR", "Chicot County"},
    {5019, "AR", "Clark County"},
    {5021, "AR", "Clay County"},
    {5023, "AR", "Cleburne County"},
    {5025, "AR", "Cleveland County"},
    {5027, "AR", "Columbia County"},
    {5029, "AR", "Conway County"},
    {5031, "AR", "Craighead County"},
    {5033, "AR", "Crawford County"},
    {5035, "AR", "Crittenden County"},
    {5037, "AR", "Cross County"},
    {5039, "AR", "Dallas County"},
    {5041, "AR", "Desha County"},
    {5043, "AR", "Drew County"},
    {5045, "AR", "Faulkner County"},
    {5047, "AR", "Franklin County"},
    {5049, "AR", "Fulton County"},
    {5051, "AR", "Garland County"},
    {5053, "AR", "Grant County"},
    {5055, "AR", "Greene County"},
    {5057, "AR", "Hempstead County"},
    {5059, "AR", "Hot Spring County"},
    {5061, "AR", "Howard County"},
    {5063, "AR", "Independence County"},
    {5065, "AR", "Izard County"},
    {5067, "AR", "Jackson County"},
    {5069, "AR", "Jefferson County"},
    {5071, "AR", "Johnson County"},
    {5073, "AR", "Lafayette County"},
    {5075, "AR", "Lawrence County"},
    {5077, "AR", "Lee County"},
    {5079, "AR", "Lincoln County"},
    {5081, "AR", "Little River County"},
    {5083, "AR", "Logan County"},
    {5085, "AR", "Lonoke County"},
    {5087, "AR", "Madison County"},
    {5089, "AR", "Marion County"},
    {5091, "AR", "Miller County"},
    {5093, "AR", "Mississippi County"},
    {5095, "AR", "Monroe County"},
    {5097, "AR", "Montgomery County"},
    {5099, "AR", "Nevada County"},
    {5101, "AR", "Newton County"},
    {5103, "AR", "Ouachita County"},
    {5105, "AR", "Perry County"},
    {5107, "AR", "Phillips County"},
    {5109, "AR", "Pike County"},
    {5111, "AR", "Poinsett County"},
    {5113, "AR", "Polk County"},
    {5115, "AR", "Pope County"},
    {5117, "AR", "Prairie County"},
    {5119, "AR", "Pulaski County"},
    {5121, "AR", "Randolph County"},
    {5123, "AR", "St. Francis County"},
    {5125, "AR", "Saline County"},
    {5127, "AR", "Scott County"},
    {5129, "AR", "Searcy County"},
    {5131, "AR", "Sebastian County"},
    {5133, "AR", "Sevier County"},
    {5135, "AR", "Sharp County"},
    {5137, "AR", "Stone County"},
    {5139, "AR", "Union County"},
    {5141, "AR", "Van Buren County"},
    {5143, "AR", "Washington County"},
    {5145, "AR", "White County"},
    {5147, "AR", "Woodruff County"},
    {5149, "AR", "Yell County"},
    {6001, "CA", "Alameda County"},
    {6003, "CA", "Alpine County"},
    {6005, "CA", "Amador County"},
    {6007, "CA", "Butte County"},
    {6009, "CA", "Calaveras County"},
    {6011, "CA", "Colusa County"},
    {6013, "CA", "Contra Costa County"},
    {6015, "CA", "Del Norte County"},
    {6017, "CA", "El Dorado County"},
    {6019, "CA", "Fresno County"},
    {6021, "CA", "Glenn County"},
    {6023, "CA", "Humboldt County"},
    {6025, "CA", "Imperial County"},
    {6027, "CA", "Inyo County"},
    {6029, "CA", "Kern County"},
    {6031, "CA", "Kings County"},
    {6033, "CA", "Lake County"},
    {6035, "CA", "Lassen County"},
    {6037, "CA", "Los Angeles County"},
    {6039, "CA", "Madera County"},
    {6041, "CA", "Marin County"},
    {6043, "CA", "Mariposa County"},
    {6045, "CA", "Mendocino County"},
    {6047, "CA", "Merced County"},
    {6049, "CA", "Modoc County"},
    {6051, "CA", "Mono County"},
    {6053, "CA", "Monterey County"},
    {6055, "CA", "Napa County"},
    {6057, "CA", "Nevada County"},
    {6059, "CA", "Orange County"},
    {6061, "CA", "Placer County"},
    {6063, "CA", "Plumas County"},
    {6065, "CA", "Riverside County"},
    {6067, "CA", "Sacramento County"},
    {6069, "CA", "San Benito County"},
    {6071, "CA", "San Bernardino County"},
    {6073, "CA", "San Diego County"},
    {6075, "CA", "San Francisco County"},
    {6077, "CA", "San Joaquin County"},
    {6079, "CA", "San Luis Obispo County"},
    {6081, "CA", "San Mateo County"},
    {6083, "CA", "Santa Barbara County"},
    {6085, "CA", "Santa Clara County"},
    {6087, "CA", "Santa Cruz County"},
    {6089, "CA", "Shasta County"},
    {6091, "CA", "Sierra County"},
    {6093, "CA", "Siskiyou County"},
    {6095, "CA", "Solano County"},
    {6097, "CA", "Sonoma County"},
    {6099, "CA", "Stanislaus County"},
    {6101, "CA", "Sutter County"},
    {6103, "CA", "Tehama County"},
    {6105, "CA", "Trinity County"},
    {6107, "CA", "Tulare County"},
    {6109, "CA", "Tuolumne County"},
    {6111, "CA", "Ventura County"},
    {6113, "CA", "Yolo County"},
    {6115, "CA", "Yuba County"},
    {8001, "CO", "Adams County"},
    {8003, "CO", "Alamosa County"},
    {8005, "CO", "Arapahoe County"},
    {8007, "CO", "Archuleta County"},
    {8009, "CO", "Baca County"},
    {8011, "CO", "Bent County"},
    {8013, "CO", "Boulder County"},
    {8014, "CO", "Broomfield County"},
    {8015, "CO", "Chaffee County"},
    {8017, "CO", "Cheyenne County"},
    {8019, "CO", "Clear Creek County"},
    {8021, "CO", "Conejos County"},
    {8023, "CO", "Costilla County"},
    {8025, "CO", "Crowley County"},
    {8027, "CO", "Custer County"},
    {8029, "CO", "Delta County"},
    {8031, "CO", "Denver County"},
    {8033, "CO", "Dolores County"},
    {8035, "CO", "Douglas County"},
    {8037, "CO", "Eagle County"},
    {8039, "CO", "Elbert County"},
    {8041, "CO", "El Paso County"},
    {8043, "CO", "Fremont County"},
    {8045, "CO", "Garfield County"},
    {8047, "CO", "Gilpin County"},
    {8049, "CO", "Grand County"},
    {8051, "CO", "Gunnison County"},
    {8053, "CO", "Hinsdale County"},
    {8055, "CO", "Huerfano County"},
    {8057, "CO", "Jackson County"},
    {8059, "CO", "Jefferson County"},
    {8061, "CO", "Kiowa County"},
    {8063, "CO", "Kit Carson County"},
    {8065, "CO", "Lake County"},
    {8067, "CO", "La Plata County"},
    {8069, "CO", "Larimer County"},
    {8071, "CO", "Las Animas County"},
    {8073, "CO", "Lincoln County"},
    {8075, "CO", "Logan County"},
    {8077, "CO", "Mesa County"},
    {8079, "CO", "Mineral County"},
    {8081, "CO", "Moffat County"},
    {8083, "CO", "Montezuma County"},
    {8085, "CO", "Montrose County"},
    {8087, "CO", "Morgan County"},
    {8089, "CO", "Otero County"},
    {8091, "CO", "Ouray County"},
    {8093, "CO", "Park County"},
    {8095, "CO", "Phillips County"},
    {8097, "CO", "Pitkin County"},
    {8099, "CO", "Prowers County"},
    {8101, "CO", "Pueblo County"},
    {8103, "CO", "Rio Blanco County"},
    {8105, "CO", "Rio Grande County"},
    {8107, "CO", "Routt County"},
    {8109, "CO", "Saguache County"},
    {8111, "CO", "San Juan County"},
    {8113, "CO", "San Miguel County"},
    {8115, "CO", "Sedgwick County"},
    {8117, "CO", "Summit County"},
    {8119, "CO", "Teller County"},
    {8121, "CO", "Washington County"},
    {8123, "CO", "Weld County"},
    {8125, "CO", "Yuma County"},
    {9001, "CT", "Fairfield County"},
    {9003, "CT", "Hartford County"},
    {9005, "CT", "Litchfield County"},
    {9007, "CT", "Middlesex County"},
    {9009, "CT", "New Haven County"},
    {9011, "CT", "New London County"},
    {9013, "CT", "Tolland County"},
    {9015, "CT", "Windham County"},
